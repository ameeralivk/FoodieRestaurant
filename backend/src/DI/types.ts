...
export const TYPES = {
  ...
  UserRefreshHandler: Symbol("UserRefreshHandler"),
  AdminRefreshHandler: Symbol("AdminRefreshHandler"),
  SuperAdminRefreshHandler:Symbol("SuperAdminRefreshHandler"),
  StaffRefreshHandler:Symbol("StaffRefreshHandler"),
  RefreshTokenFactory:Symbol("RefreshTokenFactory")
};
