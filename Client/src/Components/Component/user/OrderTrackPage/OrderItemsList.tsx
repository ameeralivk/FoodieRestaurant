...
//         if (item.itemStatus === "PREPARING" && item.preparationTime) {
//           const start = new Date(item.preparationTime).getTime();
//           const now = Date.now();
//           const seconds = Math.floor((now - start) / 1000);
//           newTimers[item._id] = seconds;
//         }
//       });
...
//                 timers[item._id] !== undefined && (
//                     <span className="text-sm font-mono text-gray-700">
//                       {formatTime(timers[item._id])}
//                     </span>
//                 )}
