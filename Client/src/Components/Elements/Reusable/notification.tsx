...
const NotificationCenter: React.FC<NotificationCenterProps> = ({
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white rounded-2xl sm:rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
      ...
      {/* List */}
      <div className="px-3 sm:px-4 pb-5 sm:pb-6 space-y-3 max-h-[60vh] sm:max-h-[400px] overflow-y-auto">
        {displayedNotifications.length === 0 && (
          <div className="text-center text-gray-500 text-sm py-6">
            No notifications
          </div>
        ...
        {displayedNotifications.map((note) => (
          <div
            key={note._id}
            className="p-3 sm:p-4 bg-white border border-gray-100 rounded-xl sm:rounded-2xl shadow-sm"
          >
            <div className="flex justify-between items-start mb-2">
            ...
            {!note.isRead && (
              <div className="flex justify-end">
                <button
                  onClick={() => onMarkAsRead(note._id)}
                  className="bg-blue-500 text-white px-3 sm:px-4 py-1 rounded-lg text-xs sm:text-sm hover:bg-blue-600"
                >
                  Mark as read
                </button>
              </div>
